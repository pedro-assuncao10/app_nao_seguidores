...
  
  // NOVO ESTADO: Controla se a imagem de fundo foi encontrada com sucesso
  const [hasHeroImage, setHasHeroImage] = useState(false);
  const heroImageUrl = "/creative-reels-composition.jpg";

  // EFEITO NOVO: Tenta carregar a imagem. Se existir, ativa a variável.
  useEffect(() => {
    const img = new Image();
...
      answer: "Não. Para garantir 100% de segurança e não exigir suas senhas, nossa ferramenta foi desenvolvida exclusivamente para computadores (Windows, Mac ou Chrome) utilizando o navegador Google Chrome."
    },
    {
...
      <main>
        {/* --- Hero Section com a Lógica de Imagem Dinâmica --- */}
        <section 
          className={`relative pt-20 pb-16 text-center ${hasHeroImage ? 'bg-cover bg-center bg-no-repeat' : ''}`}
          style={hasHeroImage ? { backgroundImage: `url('${heroImageUrl}')` } : {}}
        >
          {/* A PELÍCULA FOI REMOVIDA DAQUI 'UAI'! */}
...
                Oferta Especial
              </div>
              <div className="text-slate-500 line-through mb-1">De R$ 149,99 por apenas</div>
